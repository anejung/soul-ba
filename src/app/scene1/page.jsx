...
//     // UseEffect to enable clicking after the GIF's duration
//     useEffect(() => {
//         const gifDuration = 32000; // Set the GIF duration in milliseconds (e.g., 5000ms = 5 seconds)
//         const timer = setTimeout(() => {
//             setClickable(true); // Enable clicking after the GIF finishes
//         }, gifDuration);
...
//                 cursor: clickable ? "pointer" : "default", // Only allow pointer cursor when clickable
//             }}
//             onClick={() => {
//                 if (clickable) {
...
//     // UseEffect to enable clicking after the GIF's duration
//     useEffect(() => {
//         const gifDuration = 32000; // Set the GIF duration in milliseconds (e.g., 32000ms = 32 seconds)
//         const timer = setTimeout(() => {
//             setClickable(true); // Enable clicking after the GIF finishes
//         }, gifDuration);
...
//                     style={{
//                         position: "absolute",
//                         bottom: "10px", // Align button to the bottom of the GIF frame
//                         right: "10px", // Align button to the right corner
//                         cursor: clickable ? "pointer" : "not-allowed", // Change cursor based on clickable state
//                         opacity: clickable ? 1 : 0.5, // Dim the button if not clickable
